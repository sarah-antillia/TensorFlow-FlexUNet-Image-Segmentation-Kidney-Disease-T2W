...
if __name__ == "__main__":
  try:
    images_dir = "./Augmented-Kidney-Disease-T2W-master/images/"
    masks_dir  = "./Augmented-Kidney-Disease-T2W-master/masks/"
    output_dir = "./Augmented-Kidney-Disease-T2W-ImageMask-Dataset/"
